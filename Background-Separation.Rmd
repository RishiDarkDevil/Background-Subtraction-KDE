...
```{r human_pic_ori, fig.asp=1, fig.width=12, warning=FALSE}
...
```{r calc_prob_changes, warning=FALSE}
...
prob.change.data <- tibble(time = 90:110, prob.mot = prob.changes.motion, prob.bg = prob.changes.bg)
prob.change.data %>%
...
```{r run_func_human, warning=FALSE}
...
```{r traffic_pic_ori, fig.asp=1, fig.width=12, warning=FALSE}
...
```{r run_fun_traffic, fig.asp=1, fig.width=12, warning=FALSE}
